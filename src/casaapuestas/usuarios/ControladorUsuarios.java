...
public class ControladorUsuarios {
	...
	/**
	 * Método que permite realizar un ingreso de una <code>cantidad</code> de dinero en la cuenta de la casa de apuestas identificado por el <code>login</code>
	 * 
	 * @param login el login, o identificador único de usuario
	 * @param cantidad la cantidad a ingresar en la cuenta (positiva)
	 * @throws ExcepcionUsuario si el usuario no existe
	...
	/**
	 * Método que permite realizar un reintegro de una <code>cantidad</code> de dinero en la cuenta de la casa de apuestas identificado por el <code>login</code>
	 * 
	 * @param login el login, o identificador único de usuario
	 * @param cantidad la cantidad a ingresar en la cuenta (positiva)
	 * @throws ExcepcionUsuario si el usuario no existe
